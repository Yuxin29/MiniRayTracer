...
/**
 * @brief 	helper function to change the position of all objects in the scene
 *
 * @param 	*scene pointer to the scene struct
 * @param 	move vector to move the objects by
 */
...
/**
 * @brief 	helper function to change the orientation vector of objects by rotating it around an axis
 *
 * @param 	v vector to be rotated
 * @param 	k axis to rotate around
...
/**
 * @brief 	change the position of the camera or all objects in the scene
 *
 * @param 	*scene pointer to the scene struct
 * @param 	move vector to move the camera or objects by
 * @return void
 *
 */
...
/**
 * @brief 	scale the size of all objects in the scene
 *
 * @param 	*scene pointer to the scene struct
 * @param 	scale factor to scale the objects by
 * @return void
 *
 */
...
/**
 * @brief 	rotate the orientation vectors of objects or camera in the scene around a given axis
 *
 * @param 	*scene pointer to the scene struct
 * @param 	y_axis axis to rotate around
 * @param 	angle angle to rotate by (in radians)
 * @return void
 *
 */
