...
/**
 * @brief 	initialize the camera frame (right, up vectors)
 *
 * @param 	*cam camera containing orientation info
 * @param 	*right output right vector
 * @param 	*up output up vector
 * @return 	void
 *
 * @note	get the forward, up, right vector of the camera
...
/**
 * @brief 	initialize the viewport parameters in the scene struct
 *
 * @param 	*scene scene containing camera and viewport info	
 * @return 	void
 *
 * @note	The viewport is a 2D virtual plane in front of the camera, through which rays are cast into the 3D world
			...
			because in C, tan(), sin(), cos() expect the angle to be in radians, not degrees
...
/**
 * @brief 	generate primary ray from camera through the viewport for each pixel
 *
 * @param 	x pixel x coordinate
 * @param 	y pixel y coordinate
 * @param 	*scene scene containing camera and viewport info	
 * @return 	t_ray primary ray
 *
 * @note	Each pixel corresponds to a point on the viewport.
