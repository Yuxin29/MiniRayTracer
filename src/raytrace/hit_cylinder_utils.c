...
/**
 * @brief 	helper function to check ray-cylinder bottom cap intersection
 */
...
/**
 * @brief 	helper function to check ray-cylinder cap intersection
 *
...
/**
 * @brief 	the ray-cylinder intersection function called in hit_cylinder_body to see if the ray hits the cylinder body
 *
 * @param 	ray ray to be checked for intersection
 * @param 	*cylinder cylinde to be checked for intersection
 * @param 	*rec hit record to store intersection info	
 * @return 	bool indicating if there was a hit
 *
 ...
 *
 */
static bool	compute_cylinder_body_hit(t_hit_cy_info *hit, t_ray ray, t_cylinder *cy)
{
	float	t1;
	float	t2;
...
/**
 * @brief 	helper function to check ray-cylinder body intersection
 *
 * @param 	ray ray to be checked for intersection
 * @param 	*cylinder cylinder to be checked for intersection
 * @param 	*rec hit record to store intersection info	
